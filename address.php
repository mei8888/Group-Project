...
echo'<div style="font-size:14px; margin-left:90%; margin-top:60px; margin-bottom:-83px; color:green; font-weight:bold;">Totle: '.$rowss['FinalPrice'].'</div>';
...
</div><form method='post' action="address.php">
