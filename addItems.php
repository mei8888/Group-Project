...
echo "<tr>
    ...
    <td><form action='' method='post'>
      ...
      <button style='background-color:black; border-radius:20px;' name='deleteitfromproddd_jeknvjkwtivjn35i_unikjkjdfnv_jk59988er_' value='".$row['gam_id']."' >
        X
      </button>
...
$sqlromv =  "delete from allproducts where gam_id = '$removProId';";
...
$sql3334 = "insert into allproducts values ('$img1','$name1','$price1','$group1');";

 if(mysqli_query($conn, $sql3334)){
 echo "<script>alert(ID# Added Successfully Added);</script>";
 }
