...
$sql = "SELECT * FROM allproducts where group_num = 'iphones'";
...
echo "<div style=' margin-top:-200px'></div>
	 <div class='w3-third w3-margin-bottom'>
      <div class='w3-card-3'>
        <img height='550px' src='".$img12."' style='width:80%;'>
...
echo'<script type="text/javascript">
    ...
    window.location.href = "Iphones.php";
...
echo "<center><h3><font color='red'>0 Video Games Product found</font></h3></center>";
}
