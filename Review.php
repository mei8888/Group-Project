...
</div> <form method='post' action="Review.php">
...
echo "<address>
                        ...
                        <strong>Message: <br><div style='color:green'>".$row['da_mess']."</div></strong>
                    </address>
                </div>";
...
echo "<tr>
	 	<td class='col-md-4'><em></em><img style='' height='100px' src='".$row['pro_img']."' style='width:100px;'>
        </h4></td>
    	<td style='text-align:left; font-weight:bold;'>".ucfirst($row['pro_name'])."</td>
    	<th></th>
        <td class='col-md-1 text-center' style='font-weight:bold;'>$".$row['pro_price']."</td>
...
echo "<thead>
                        <tr style='background-color:white;'>
                            ...
                            <th style='color:black; font-size:18px;'> </th>
                            <th style='color:black; font-size:18px;'>Totle:</th>
